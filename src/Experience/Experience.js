    ...
    return (
        ...
        <div className="text-container">
            <div class="row">
                ...
                <div className="third tile">
                    <div className="text">
                        <h4 class="job-title">Web Developer, Rogers Media</h4>
                        <p class="date">February 2020 - present</p>
                        <p>Contracted to build internal and external tools, and maintain partner sites for Rogers Media brands including Sportsnet, Chatelaine, and Breakfast Television.</p>
                        <p>Stack - Javascript, jQuery, PHP, Git, Github, SCSS, HTML5</p>
                    </div>
                </div>
            </div>
